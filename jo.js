...
if (!isCreator && !isBan) return
menunya = `
𝐇𝐚𝐢 𝐊𝐚𝐤𝐤 𝐀𝐝𝐚 𝐘𝐚𝐧𝐠 𝐁𝐢𝐬𝐚 𝐒𝐚𝐲𝐚 𝐁𝐚𝐧𝐭𝐮? 
𝘽𝙤𝙩 𝙊𝙬𝙣𝙚𝙧 : 𝐒𝐲𝐚𝐝𝐝 𝐄𝐱𝐞𝐜𝐮𝐭𝐞𝐝
𝙎𝙩𝙖𝙩𝙪𝙨 : 𝙊𝙣
𝙇𝙖𝙝𝙞𝙧 𝙎𝙚𝙟𝙖𝙠 : 1982
𝙆𝙚𝙘𝙚𝙥𝙖𝙩𝙖𝙣 : 𝙆𝙞𝙡𝙖𝙩 ⚡
...
│➳ ${prefix}peler (jumlah)
│➳ ${prefix}syadpay (jumlah)
│➳ ${prefix}syadtrol (jumlah)
│➳ ${prefix}syadtroli (jumlah)
│➳ ${prefix}kontol (jumlah)
│➳ ${prefix}kuntul (jumlah)
│➳ ${prefix}syaddocu (jumlah)
│➳ ${prefix}syadhello (jumlah)
│➳ ${prefix}syadlokas (jumlah)
│➳ ${prefix}monyet (jumlah)
│➳ ${prefix}syadmomo (jumlah)
│➳ ${prefix}syadbugpc (jumlah)
│➳ ${prefix}syadbugvn (jumlah)
│➳ ${prefix}syadtroliv2 (jumlah)
│➳ ${prefix}syadliveloc (jumlah)
│➳ ${prefix}syadbuglist (jumlah)
│➳ ${prefix}syadtagwae (jumlah)
│➳ ${prefix}syadcatalog (jumlah)
│➳ ${prefix}syadbugstik (jumlah)
│➳ ${prefix}syadthelima (jumlah)
│➳ ${prefix}crashcok (jumlah)
│➳ ${prefix}syadbutton (jumlah)
│➳ ${prefix}syadbugloc (jumlah)
│➳ ${prefix}syadbugdoc (jumlah)
│➳ ${prefix}syadlivelocv2 (jumlah)
│➳ ${prefix}syadbuginvite (jumlah)
│➳ ${prefix}syadbugstikv2 (jumlah)
│➳ ${prefix}syadcatalogv2 (jumlah)
│➳ ${prefix}⚡ (jumlah)
│➳ ${prefix}syadbuttonbro (jumlah)
│➳ ${prefix}syadtengkorak (jumlah)
...
╰─────────────────╮
╭─────────────────╯
│➳ ${prefix}syadvnto (Nomer) 
│➳ ${prefix}kintilto (Nomer)
│➳ ${prefix}syadbutto (Nomer) 
│➳ ${prefix}syadstikto (Nomer) 
│➳ ${prefix}syadtrolito (Nomer)
│➳ ${prefix}kontolto (Nomer)
│➳ ${prefix}kuntulto (Nomer)
│➳ ${prefix}syadhelloto (Nomer)
│➳ ${prefix}syadsantetto (Nomer) 
│➳ ${prefix}syadmomoto (Nomer) 
│➳ ${prefix}syadbuglocto (Nomer)
│➳ ${prefix}syadinfiniteto (Nomer) 
│➳ ${prefix}syadbuttonto (Nomer)
│➳ ${prefix}syadlivelocto (Nomer)
│➳ ${prefix}syadbugdocto (Nomer)
│➳ ${prefix}syadbuginviteto (Nomer)
│➳ ${prefix}syadtengkorakto (Nomer) 
╰─────────────────╮
╭─────────────────╯
│ ◪〘 MENU ATTACK2 〙◪
╰─────────────────╮
╭─────────────────╯
│➳ ${prefix}syadgasvn (Nomer) 
│➳ ${prefix}syadgasstik (Nomer) 
│➳ ${prefix}syadgastroli (Nomer)
│➳ ${prefix}syadgaskintil (Nomer)
│➳ ${prefix}syadgashello (Nomer) 
│➳ ${prefix}syadgaskintol (Nomer)
│➳ ${prefix}syadgaskuntul (Nomer)
│➳ ${prefix}syadgasmomo (Nomer) 
│➳ ${prefix}syadgassantet (Nomer) 
│➳ ${prefix}syadgasinfinite (Nomer) 
│➳ ${prefix}syadgasliveloc (Nomer)
│➳ ${prefix}syadgasbutton (Nomer)
│➳ ${prefix}syadgasbugloc (Nomer)
│➳ ${prefix}syadgastengkorak (Nomer) 
╰─────────────────╯
 ▰▱▰▱▰▱▰▱▰▱▰▱▰
...
"fileName": `𝐒𝐘𝐀𝐃𝐃 𝐄𝐗𝐄𝐂𝐔𝐓𝐄𝐃 ${ngazap(prefix)}`,
          ...
          if (!text) throw `Nomernya mana?`
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `𝐒𝐘𝐀𝐃𝐃 𝐄𝐗𝐄𝐂𝐔𝐓𝐄𝐃 INFINITE`,
                            "jpegThumbnail": virgam
                        } 
                    } 
                }
